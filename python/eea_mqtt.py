#
# This file handles the MQTT communication with the Wegnology broker.
...
def init(device_id, access_key, access_secret, eea_queue, mqtt_queue):
  ...
  def thread():
    ...
    def on_connect(client, userdata, flags, rc):
      ...
      if rc == 0:
        client.subscribe("wnology/" + device_id + "/command")
        client.subscribe("wnology/" + device_id + "/toAgent/#")
