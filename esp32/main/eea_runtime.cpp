 ...
 * 
 * https://docs.app.wnology.io//edge-compute/embedded-edge-agent/agent-api/#bundle-identifier
 */
void send_hello_message(const char *bundle_version, QueueHandle_t xQueueMQTT)
{
  ...
  topic_length = sprintf(topic, "wnology/%s/fromAgent/hello", WNOLOGY_DEVICE_ID );
